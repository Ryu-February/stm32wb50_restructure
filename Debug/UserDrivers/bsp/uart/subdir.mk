...
C_SRCS += \
../UserDrivers/bsp/uart/uart.c 

OBJS += \
./UserDrivers/bsp/uart/uart.o 

C_DEPS += \
./UserDrivers/bsp/uart/uart.d 


# Each subdirectory must supply rules for building sources it contributes
UserDrivers/bsp/uart/%.o UserDrivers/bsp/uart/%.su UserDrivers/bsp/uart/%.cyclo: ../UserDrivers/bsp/uart/%.c UserDrivers/bsp/uart/subdir.mk
...
clean: clean-UserDrivers-2f-bsp-2f-uart

clean-UserDrivers-2f-bsp-2f-uart:
	-$(RM) ./UserDrivers/bsp/uart/uart.cyclo ./UserDrivers/bsp/uart/uart.d ./UserDrivers/bsp/uart/uart.o ./UserDrivers/bsp/uart/uart.su

.PHONY: clean-UserDrivers-2f-bsp-2f-uart
